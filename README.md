...
| NSIS 安装包 | `target\release\bundle\release\CodexSoundManager_1.3.1_x64-setup.exe` |
| 便携 ZIP | `target\release\bundle\portable\CodexSoundManager_1.3.1_x64-portable.zip` |
